...
The Appendix \ref{appendix} also shows with benchmarks that stream generators are faster than lazy lists.
...
Part of this work was supported by the Flemish Fund for Scientific Research (grant G0D1419N).
