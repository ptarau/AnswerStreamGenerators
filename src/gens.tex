...
Stream processing, now prevalent in widely used programming languages languages like Java, Python, C\#, go or JavaScript offers a uniform and (mostly) declarative view on processing finite 
